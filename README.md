...
The first session requires only individual access and Sandbox sign-in. It opens with a live comparison of two small models on the nurse question, followed by the car-wash demonstration and handoff, in-chat system prompting, and guided Workspace practice.
